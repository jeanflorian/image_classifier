...
def main():
    ...
    #saving checkpoint
    save_checkpoint(trained_model, input_size, train_class_to_idx, args.hidden_units, args.epochs, optimizer, args.save_dir, args.arch)
    
    print('Operation successfully completed! Network saved!')
   
    
def save_checkpoint(model, input_size, train_class_to_idx, hidden_units, epochs, optimizer, save_dir, arch):
